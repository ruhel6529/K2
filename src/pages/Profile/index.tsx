    ...
    return (
        <div className="profile">
            ...
            >
                ...
                <p style={{color: 'white'}}>Welcome to your account hub, your gateway to topping up credits and
                    exploring your gallery of saved
                    photos.</p>
                <h3 style={{marginTop: 24}}>Current Credits: {userCredits}</h3>
                <p>These credits are the remaining balance on your subscription.</p>

                <h3 style={{ marginTop: 24 }}>Need more credits? We&apos;ve got you covered!</h3>
